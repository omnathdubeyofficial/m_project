...
const Competition_Management_Form = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      setFormData({ ...formData, competitionBanner: URL.createObjectURL(file) });
    }
  };

  const handleClearFile = () => {
    setFormData({ ...formData, competitionBanner: null });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Competition Data Submitted:", formData);
  };
      ...
      <div className="container mx-auto py-10 px-4 sm:px-6 md:px-8 max-w-8xl pt-32">
        <div className="bg-white shadow-lg p-6 sm:p-8 w-full relative">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-5">
            ...
            <h2 className="text-2xl text-center text-gray-800">Competition Management Form</h2>
          </div>

          <form onSubmit={handleSubmit} className="grid gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { name: "competitionName", label: "Competition Name" },
            ...
            <div className="flex flex-col items-center border p-4 rounded-lg w-full relative mt-4">
              <label className="font-semibold text-lg mb-2">Upload Competition Banner</label>
              ...
              {formData.competitionBanner && (
                <div className="relative mt-2">
                  <Image src={formData.competitionBanner} className="w-32 h-32 border object-cover" alt="Competition Banner" />
                  <button
                    type="button"
...
export default Competition_Management_Form;
