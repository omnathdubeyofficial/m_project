            ...
            <div className="flex items-center space-x-4 pt-4 md:pt-8">
              <div className="text-center md:text-right">
                <h1 className="text-sm sm:text-base text-gray-800">
                  {user.first_name || "N/A"} {user.middle_name || ""} {user.last_name || ""}
                </h1>
                <p className="text-xs sm:text-sm text-gray-600">User ID: {user.userid || "N/A"}</p>
                <p className="text-xs sm:text-sm text-gray-600">Email: {user.email || "N/A"}</p>
                <p className="text-xs sm:text-sm text-gray-600">Contact: {user.contact_no || "N/A"}</p>
              </div>
              <Image 
                src={user.profileImg || "/img/default-profile.png"} 
                alt="Profile" 
                width={64} 
                height={64} 
