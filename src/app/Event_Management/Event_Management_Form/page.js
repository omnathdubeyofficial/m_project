...
const Event_Management_Form = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      setFormData({ ...formData, eventBanner: URL.createObjectURL(file) });
    }
  };

  const handleClearFile = () => {
    setFormData({ ...formData, eventBanner: null });
      ...
      <div className="container mx-auto py-10 px-4 sm:px-6 md:px-8 max-w-8xl pt-32">
        <div className="bg-white shadow-lg p-6 sm:p-8 w-full relative ">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-5">
            ...
            <h2 className="text-2xl text-center text-gray-800">Event Management Form</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="grid gap-6">
            ...
            <div className="flex flex-col border-t pt-6">
              <label className="font-semibold mb-1">Event Description</label>
              <textarea
            ...
            <div className="flex flex-col items-center border p-4 rounded-lg w-full relative mt-4">
              <label className="font-semibold text-lg mb-2">Upload Event Banner</label>
...
export default Event_Management_Form;
