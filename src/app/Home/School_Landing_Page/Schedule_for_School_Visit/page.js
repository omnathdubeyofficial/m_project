...
const heroContent = [
  {
    ...
    description: "Schedule a visit to experience our world-class facilities and vibrant community.",
  },
  {
    image: "/img/admission-cinematic2.jpg",
    title: "Discover Excellence",
    description: "Book a tour to see our innovative learning spaces and meet our dedicated staff.",
  },
  {
    image: "/img/admission-cinematic3.jpg",
    title: "Join Our Family",
    description: "Arrange a visit to witness the nurturing environment where your child will thrive.",
  },
];

export default function ScheduleSchoolVisit() {
  ...
  const validateField = (name, value) => {
    if (name === "parentName" || name === "studentName" || name === "visitDate" || name === "visitTime") {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      setFormStatus({ type: "success", message: "Visit scheduled successfully! We’ll confirm soon." });
      setFormData({
        parentName: "",
        email: "",
        phone: "",
    ...
    <div className="bg-[#FAF9F6] text-gray-900">
      ...
      <div className="py-24 bg-[#D1E7DD]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="mt-6 text-lg text-gray-600 text-center max-w-3xl mx-auto">
            Book a tour to explore our campus and learn more about our educational programs. Our team will confirm your visit shortly.
          </p>
          <div className="mt-12 bg-[#FAF9F6] p-8 rounded-3xl shadow-[inset_0_2px_8px_rgba(0,0,0,0.05)] max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`mt-2 w-full p-3 rounded-lg bg-[#FAF9F6] text-gray-900 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#D4A017] transition-all duration-300 shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)] ${
                      errors.visitTime ? "border-red-500" : ""
                    }`}
                  >
      ...
      <div className="py-24 bg-[#FAF9F6]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="mt-6 text-lg text-gray-600 text-center max-w-3xl mx-auto">
            Locate our school easily and plan your visit to explore our state-of-the-art facilities.
          </p>
      ...
      <div className="py-24 bg-[#D1E7DD]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto">
            Schedule your campus tour today or contact our admissions team to learn more about our programs.
          </p>
