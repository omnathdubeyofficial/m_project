...
import { useState, useEffect, useMemo } from "react"; // useMemo इम्पोर्ट करें
import Image from "next/image";

export default function FacilitiesInfrastructure() {
  // facilities को useMemo में लपेटें
  ...
  return (
    <section className="lg:py-20 py-10 bg-gradient-to-r from-[#001F3F] to-[#003366]/80 text-white">
      <div className="max-w-7xl mx-auto lg:px-12 px-4">
        <h2 className="text-4xl lg:text-5xl font-semibold lg:text-center text-left mb-8">
          Facilities & Infrastructure
        </h2>
        <p className="text-lg lg:text-center text-left mb-12 opacity-80">
          Experience a world-class infrastructure designed to enhance learning,
...
//                     }
//                     className={`w-3 h-3 rounded-full transition-all border border-white ${
//                       activeIndexes[facilityIndex] === imageIndex ? "bg-white" : "bg-transparent"
//                     }`}
//                   />
//                 ))}
//               </div>
