...
import React, { useState, useEffect, useMemo } from "react"; // useMemo इम्पोर्ट करें
...
const FacultyPage = () => {
  ...
  // Define color schemes for departments using useMemo
  const colorSchemes = useMemo(
    ...
    [] // खाली डिपेंडेंसी ऐरे, क्योंकि colorSchemes स्थिर है
  );
  ...
  useEffect(() => {
      ...
      try {
        ...
        const groupedData = faculty.reduce((acc, member) => {
          ...
          acc[dept].members.push({
            ...
            image: member.profile_image || "/img/placeholder.png",
    ...
    fetchFaculty();
  }, [colorSchemes]); // colorSchemes को डिपेंडेंसी में जोड़ा
