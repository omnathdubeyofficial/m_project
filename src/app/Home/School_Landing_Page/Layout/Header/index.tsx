...
import { useState, useEffect, useRef, useCallback } from "react"; // useCallback इम्पोर्ट करें
...
}, [setIsSticky]); // setIsSticky डिपेंडेंसी के रूप में
...
useEffect(() => {
  ...
  // Close dropdown and mobile menu when clicking outside, wrapped in useCallback
  const handleClickOutside = useCallback(
    ...
    [isMenuOpen, activeDropdown] // Dependencies for handleClickOutside
  );
  ...
  }, [handleClickOutside, handleScroll]); // Added handleClickOutside and handleScroll as dependencies
