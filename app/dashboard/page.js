...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="w-full max-w-6xl p-8 bg-white dark:bg-gray-800 shadow-2xl rounded-none lg:rounded-2xl">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-6 sm:mb-8 ">
        ...
        <div className="flex flex-col items-center md:flex-row space-y-4 md:space-y-0 md:space-x-4">
          <Image
            ...
            height={60}
          />
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl  text-center md:text-left text-gray-800 dark:text-white">
...
{user && (
  <div className="flex items-center space-x-4 pt-4 md:pt-8">
    <div className="text-center md:text-right">
      <h1 className="text-sm sm:text-base text-gray-800 dark:text-white">
        {user.username}
      </h1>
    ...
    />
      ...
      <div className="absolute top-4 right-4">
        <button
          onClick={toggleTheme}
          className="flex items-center justify-center p-2 sm:p-3 bg-gray-100 rounded-full shadow-lg hover:bg-gray-200 transition-all"
        >
          {isDarkMode ? (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mt-6">
        ...
        >
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-blue-800 mt-2 sm:mt-4">
            University Corner
          </h2>
          <p className="text-gray-700 text-sm sm:text-base mt-1 sm:mt-2">
            Manage university operations and settings.
          </p>
        </div>
  
        <div
          onClick={() => router.push('/student')}
          className="p-4 sm:p-6 bg-gradient-to-r from-green-100 to-green-200 rounded-xl shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 cursor-pointer"
        >
          <FaUserGraduate className="text-3xl sm:text-4xl text-green-800" />
          <h2 className="text-lg sm:text-xl font-semibold text-green-800 mt-2 sm:mt-4">
            Student Corner
          </h2>
          <p className="text-gray-700 text-sm sm:text-base mt-1 sm:mt-2">
        ...
        <div
          ...
          className="p-4 sm:p-6 bg-gradient-to-r from-purple-100 to-purple-200 rounded-xl shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 cursor-pointer"
        >
          <FaUserTie className="text-3xl sm:text-4xl text-purple-800" />
          <h2 className="text-lg sm:text-xl font-semibold text-purple-800 mt-2 sm:mt-4">
            Parent Corner
          </h2>
          <p className="text-gray-700 text-sm sm:text-base mt-1 sm:mt-2">
            Access reports and communication tools for parents.
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-6 sm:mt-8">
        <button
          ...
          className="flex items-center px-6 sm:px-8 py-2 sm:py-3 bg-red-500 text-white text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:bg-red-600 transition-all"
        >
